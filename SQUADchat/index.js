...
window.onload = function() {
    ...
    class SQUAD_CHAT{
      ...
      // create_chat() creates the chat container
      create_chat(){
        ...
        parent.create_load('chat_content_container')
        // "refresh" and get the chat data from Firebase
        parent.refresh_chat()
      }
      // Save name, saves the name to localStorage
      save_name(name){
    ...
    var app = new SQUAD_CHAT()
    // If we have a name stored in localStorage.
    // Then use that name. Otherwise , 
    // Go to home.
